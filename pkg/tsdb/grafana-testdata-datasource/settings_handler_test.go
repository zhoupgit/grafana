...
func TestSettingsHandler(t *testing.T) {
	...
	s, err := svc.CreateInstanceSettings(context.Background(), &backend.CreateInstanceSettingsRequest{
		// empty
	})
	...
	// Empty is OK
	s, _ = svc.CreateInstanceSettings(context.Background(), &backend.CreateInstanceSettingsRequest{
