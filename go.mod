...
require (
	...
	github.com/grafana/cog v0.0.0-20240828114857-e705169a9b4f //@grafana/grafana-as-code
...
require github.com/grafana/grafana/apps/playlist v0.0.0-20240917082838-e2bce38a7990 // @grafana/grafana-app-platform-squad
